...
let sinWave (f : Sound [], n : int, duration : float) =    
...
let squareWave (f : Sound [], n : int, duration : float) =    
    let buffer = Array.zeroCreate<uint8> (int (float n * duration))
    let tones = f.Length - 1
    for i = 0 to buffer.Length - 1 do
        let mutable value = 0.0
...
let sawWave (f : Sound [], n : int, duration : float) =    
    let buffer = Array.zeroCreate<uint8> (int (float n * duration))
    let tones = f.Length - 1
    for i = 0 to buffer.Length - 1 do
        let mutable value = 0.0
...
let triangleWave (f : Sound [], n : int, duration : float) =    
    let buffer = Array.zeroCreate<uint8> (int (float n * duration))
    let tones = f.Length - 1
    for i = 0 to buffer.Length - 1 do
        let mutable value = 0.0
